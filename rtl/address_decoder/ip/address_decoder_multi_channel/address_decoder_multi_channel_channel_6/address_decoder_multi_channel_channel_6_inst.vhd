	component address_decoder_multi_channel_channel_6 is
		generic (
	...
	end component address_decoder_multi_channel_channel_6;

	u0 : component address_decoder_multi_channel_channel_6
		generic map (
