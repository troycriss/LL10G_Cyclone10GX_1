	component address_decoder_multi_channel_channel_1 is
		generic (
	...
	end component address_decoder_multi_channel_channel_1;

	u0 : component address_decoder_multi_channel_channel_1
		generic map (
