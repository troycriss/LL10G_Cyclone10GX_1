	component address_decoder_multi_channel_channel_0 is
		generic (
	...
	end component address_decoder_multi_channel_channel_0;

	u0 : component address_decoder_multi_channel_channel_0
		generic map (
