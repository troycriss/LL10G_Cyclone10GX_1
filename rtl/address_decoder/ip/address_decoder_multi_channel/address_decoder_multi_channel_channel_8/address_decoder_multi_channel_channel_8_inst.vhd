	component address_decoder_multi_channel_channel_8 is
		generic (
	...
	end component address_decoder_multi_channel_channel_8;

	u0 : component address_decoder_multi_channel_channel_8
		generic map (
