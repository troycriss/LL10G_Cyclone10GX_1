	component address_decoder_multi_channel_channel_2 is
		generic (
	...
	end component address_decoder_multi_channel_channel_2;

	u0 : component address_decoder_multi_channel_channel_2
		generic map (
