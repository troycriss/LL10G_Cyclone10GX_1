	component address_decoder_multi_channel_channel_5 is
		generic (
	...
	end component address_decoder_multi_channel_channel_5;

	u0 : component address_decoder_multi_channel_channel_5
		generic map (
