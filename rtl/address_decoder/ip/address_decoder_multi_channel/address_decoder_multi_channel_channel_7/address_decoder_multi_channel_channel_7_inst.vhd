	component address_decoder_multi_channel_channel_7 is
		generic (
	...
	end component address_decoder_multi_channel_channel_7;

	u0 : component address_decoder_multi_channel_channel_7
		generic map (
