	component address_decoder_multi_channel_channel_3 is
		generic (
	...
	end component address_decoder_multi_channel_channel_3;

	u0 : component address_decoder_multi_channel_channel_3
		generic map (
