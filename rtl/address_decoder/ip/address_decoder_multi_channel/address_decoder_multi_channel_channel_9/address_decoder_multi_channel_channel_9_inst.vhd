	component address_decoder_multi_channel_channel_9 is
		generic (
	...
	end component address_decoder_multi_channel_channel_9;

	u0 : component address_decoder_multi_channel_channel_9
		generic map (
