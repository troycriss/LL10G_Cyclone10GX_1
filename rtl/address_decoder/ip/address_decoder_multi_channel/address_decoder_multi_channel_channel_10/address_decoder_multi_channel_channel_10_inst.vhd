	component address_decoder_multi_channel_channel_10 is
		generic (
	...
	end component address_decoder_multi_channel_channel_10;

	u0 : component address_decoder_multi_channel_channel_10
		generic map (
