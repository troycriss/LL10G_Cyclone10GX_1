	address_decoder_multi_channel_channel_10 #(
		...
		.uav_address       (_connected_to_uav_address_),       //   input,  width = 16, avalon_universal_slave_0.address
		.uav_burstcount    (_connected_to_uav_burstcount_),    //   input,   width = 3,                         .burstcount
		...
		.av_address        (_connected_to_av_address_),        //  output,  width = 16,      avalon_anti_slave_0.address
