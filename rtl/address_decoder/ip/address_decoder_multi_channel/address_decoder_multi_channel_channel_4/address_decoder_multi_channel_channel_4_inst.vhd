	component address_decoder_multi_channel_channel_4 is
		generic (
	...
	end component address_decoder_multi_channel_channel_4;

	u0 : component address_decoder_multi_channel_channel_4
		generic map (
