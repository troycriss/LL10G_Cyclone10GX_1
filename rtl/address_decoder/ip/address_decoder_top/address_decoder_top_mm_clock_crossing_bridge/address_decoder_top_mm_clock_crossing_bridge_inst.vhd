	component address_decoder_top_mm_clock_crossing_bridge is
		generic (
	...
	end component address_decoder_top_mm_clock_crossing_bridge;

	u0 : component address_decoder_top_mm_clock_crossing_bridge
		generic map (
