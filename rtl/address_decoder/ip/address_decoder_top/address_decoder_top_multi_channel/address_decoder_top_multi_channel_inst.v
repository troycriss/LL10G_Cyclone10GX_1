	address_decoder_top_multi_channel #(
		...
		.uav_address       (_connected_to_uav_address_),       //   input,  width = 20, avalon_universal_slave_0.address
		...
		.av_address        (_connected_to_av_address_),        //  output,  width = 20,      avalon_anti_slave_0.address
