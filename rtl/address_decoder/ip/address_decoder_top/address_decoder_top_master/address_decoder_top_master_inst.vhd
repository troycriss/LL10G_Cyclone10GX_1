	component address_decoder_top_master is
		generic (
	...
	end component address_decoder_top_master;

	u0 : component address_decoder_top_master
		generic map (
		...
		port map (
			...
			av_readdatavalid  => CONNECTED_TO_av_readdatavalid,  --                          .readdatavalid
