...
module address_decoder_top_master #(
	...
	address_decoder_top_master_altera_merlin_master_translator_181_mhudjri #(
		...
		.uav_burstcount         (uav_burstcount),    //  output,   width = 3,                          .burstcount
		...
		.av_address             (av_address),        //   input,  width = 26,      avalon_anti_master_0.address
		...
		.av_readdatavalid       (av_readdatavalid),  //  output,   width = 1,                          .readdatavalid
