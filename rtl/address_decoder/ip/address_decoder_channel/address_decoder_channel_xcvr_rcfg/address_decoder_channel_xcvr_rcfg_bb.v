module address_decoder_channel_xcvr_rcfg #(
		...
		input  wire [11:0] uav_address,       // avalon_universal_slave_0.address
		...
		output wire [9:0]  av_address,        //      avalon_anti_slave_0.address
