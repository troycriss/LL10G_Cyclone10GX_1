	address_decoder_channel_xcvr_rcfg #(
		...
		.uav_address       (_connected_to_uav_address_),       //   input,  width = 12, avalon_universal_slave_0.address
		...
		.av_address        (_connected_to_av_address_),        //  output,  width = 10,      avalon_anti_slave_0.address
