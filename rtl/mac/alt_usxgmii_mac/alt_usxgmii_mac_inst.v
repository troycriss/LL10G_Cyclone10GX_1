	alt_usxgmii_mac u0 (
		...
		.xgmii_tx_valid                  (_connected_to_xgmii_tx_valid_),                  //  output,   width = 1,             xgmii_tx_valid.out
		.xgmii_rx_valid                  (_connected_to_xgmii_rx_valid_),                  //   input,   width = 1,             xgmii_rx_valid.in
		...
		.avalon_st_tx_data               (_connected_to_avalon_st_tx_data_),               //   input,  width = 64,                           .data
		.avalon_st_tx_empty              (_connected_to_avalon_st_tx_empty_),              //   input,   width = 3,                           .empty
		...
		.xgmii_tx_data                   (_connected_to_xgmii_tx_data_),                   //  output,  width = 32,              xgmii_tx_data.export
		.xgmii_tx_control                (_connected_to_xgmii_tx_control_),                //  output,   width = 4,           xgmii_tx_control.export
		...
		.xgmii_rx_data                   (_connected_to_xgmii_rx_data_),                   //   input,  width = 32,              xgmii_rx_data.export
		.xgmii_rx_control                (_connected_to_xgmii_rx_control_),                //   input,   width = 4,           xgmii_rx_control.export
		...
		.avalon_st_rx_data               (_connected_to_avalon_st_rx_data_),               //  output,  width = 64,               avalon_st_rx.data
		...
		.avalon_st_rx_empty              (_connected_to_avalon_st_rx_empty_),              //  output,   width = 3,                           .empty
