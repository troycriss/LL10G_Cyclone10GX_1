...
namespace eval alt_usxgmii_mac {
  proc get_design_libraries {} {
    set libraries [dict create]
    dict set libraries alt_em10g32_181 1
    dict set libraries alt_usxgmii_mac 1
    return $libraries
  }
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/alt_usxgmii_mac.v"]\"  -work alt_usxgmii_mac"                                                                                                 
    return $design_files
  }
