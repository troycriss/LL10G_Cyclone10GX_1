...
# ACDS 18.1 222 win32 2023.02.16.09:35:18
# ----------------------------------------
# Auto-generated simulation script rivierapro_setup.tcl
# ----------------------------------------
# This script provides commands to simulate the following IP detected in
# your Quartus project:
#     alt_mge_xcvr_reset_ctrl_txpll
# 
...
# ----------------------------------------
# If alt_mge_xcvr_reset_ctrl_txpll is one of several IP cores in your
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [alt_mge_xcvr_reset_ctrl_txpll::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [alt_mge_xcvr_reset_ctrl_txpll::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [alt_mge_xcvr_reset_ctrl_txpll::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [alt_mge_xcvr_reset_ctrl_txpll::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [alt_mge_xcvr_reset_ctrl_txpll::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [alt_mge_xcvr_reset_ctrl_txpll::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [alt_mge_xcvr_reset_ctrl_txpll::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
