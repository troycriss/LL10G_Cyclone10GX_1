...
namespace eval alt_mge_xcvr_reset_ctrl_channel {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    lappend design_files "vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"[normalize_path "$QSYS_SIMDIR/alt_mge_xcvr_reset_ctrl_channel.v"]\"  -work alt_mge_xcvr_reset_ctrl_channel"                                         
    return $design_files
  }
